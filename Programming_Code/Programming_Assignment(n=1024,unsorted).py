...
#랜덤 리스트 생성 및 파일이름 정의
name = create_random_list(1024 , "unsorted_array")
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Insertion_sort(n=1024)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Heap_sort(n=1024)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Merge_sort(n=1024)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort1(n=1024)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort2(n=1024)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort3(n=1024)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort4(n=1024)_result")