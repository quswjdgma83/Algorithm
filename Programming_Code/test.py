...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Insertion_sort(n=32, sorted input)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Heap_sort(n=32, sorted input)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Merge_sort(n=32, sorted input)_result")
comp_reset()

################################# Quick Sort1(pivot = start) ##################################################
unsorted_array = open_file(name) #초기화
unsorted_array.sort()
...
print(f"quick_sort1결과 : {sorted}")
print(f"quick_sort1 comparison 횟수 : {comp}")
print(f"quick_sort1에 걸린 시간 : {time_ns} nano_sec\n")
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort1(n=32, sorted input)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort2(n=32, sorted input)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort3(n=32, sorted input)_result")
comp_reset()
...
save_sorted_list(unsorted_array, sorted, comparison, time_ns, "Quick_sort4(n=32, sorted input)_result")